...
interface PasswordRecoveryStepThreeProps {
...
export function PasswordRecoveryStepThree({
  onSubmit,
  isLoading,
  defaultValues = { password: "", confirmPassword: "" },
}: PasswordRecoveryStepThreeProps) {
  const t = useTranslations("page.password-recovery.stepThree");
